package com.preraktrivedi.android.mvvmbaseapp.network.interceptors;

import android.net.Uri;
import android.text.TextUtils;
import android.util.Log;

import com.preraktrivedi.android.mvvmbaseapp.BaseApplication;
import com.preraktrivedi.android.mvvmbaseapp.helpers.Util;
import com.preraktrivedi.android.mvvmbaseapp.network.NetworkClient;
import com.preraktrivedi.android.mvvmbaseapp.network.mock.MockApiResponseConfig;
...
public class MockResponseInterceptor implements Interceptor {
    ...
    private String getResponseFromJson(String filePath) {
        String responseBody = "";
        try {
            responseBody = Util.readAssetFile(BaseApplication.getContext(), filePath);
        } catch (Exception ex) {
